...
create_secret_if_missing "nsx_api_token"    "Token de API do NSX-T (Auditor role):"
create_secret_if_missing "postgres_password" "Senha do PostgreSQL (escolha uma senha forte):"
create_secret_if_missing "api_secret_key"   "Chave secreta da API (ou pressione Enter para gerar automaticamente):"

# ── Iniciar Docker Swarm (necessário para Docker Secrets) ──
